...
ROBLOX_PLACE_ID = os.getenv("ROBLOX_PLACE_ID")
...
if __name__ == "__main__":
    if not all([ROBLOX_API_KEY, ROBLOX_UNIVERSE_ID, ROBLOX_PLACE_ID]):
        print("Error: ROBLOX_API_KEY, ROBLOX_UNIVERSE_ID, and ROBLOX_PLACE_ID environment variables must be set.", file=sys.stderr)
        exit(1)
